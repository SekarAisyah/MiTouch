...
var KTDashboard = function() {
    ...
    var revenueChange = function() {
       ...
       var ta_name_1 =  $('#ta_name_1').val();
       var ta_value_1 =  $('#ta_value_1').val();
       var ta_name_2 =  $('#ta_name_2').val();
       var ta_value_2 =  $('#ta_value_2').val();
       var ta_name_3 =  $('#ta_name_3').val();
       var ta_value_3 =  $('#ta_value_3').val();
    ...
    //DASHBOARD ICOM
    var dashJumlahRules = function() {
        if ($('#dashbJumlahRules').length == 0) {
            return;
        }
       var val_internal =  $('#val_internal').val();
       var val_eksternal =  $('#val_eksternal').val();

        Morris.Donut({
            element: 'dashbJumlahRules',
            data: [{
                    label: "Internal",
                    value: val_internal
                },
    ...
    var bar_total_hmin = function() {
        // if ($('#bar_total_alert').length == 0) {
        //     return;
        // }
        // $.ajax({
        //     url : 'dashboard/total_color',
        //     type: "GET",
        //     dataType: "json",
        //     success: function(data, textStatus, jqXHR){

                Morris.Donut({
                    element: 'bar_total_hmin',
                    data: [{
                            label: "Green",
                            value: 15
                        },
