...
@section('content')
                    ...
                    <div class="card-body">
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form class="row g-3 needs-validation" method="POST" action="/pascapelatihan/create"
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form class="row g-3 needs-validation" id="formedit"
                                            action="/pascapelatihan/myedit/{id}" enctype="multipart/form-data">
                                            @csrf
                                            @method('POST')
                                            <div class="col-md-6">
                                                <div class="form-floating">
                        ...
                        <div class="container">
                            <table class="table dt_pelatihan" id="datatable">
                                ...
                                <tbody>
                                    {{-- //sekar --}}
                                    @foreach ($pascapelatihanData as $no => $pascapelatihan)
                                        <tr>
                                            <td>{{ $no + 1 }}</td>
                                            <td>{{ $pascapelatihan->nrp }}</td>
                                            <td>{{ $pascapelatihan->username }}</td>
                                            <td>{{ $pascapelatihan->departemen }}</td>
                                            <td>{{ $pascapelatihan->perusahaan }}</td>
                                            <td class="truncate-text">{{ $pascapelatihan->ringkasan }}</td>
                                            <td>
                                                <a class="btn bi bi-file-earmark-text-fill text-primary"
                                                    href="{{ asset('storage/app/'.$pascapelatihan->file_path) }}" target="_blank">
                                                </a>
                                            </td>
                                            <td>
                                                <div class="dropdown">
    ...
    <script>
        ...
        $('.view').click(function() {
            ...
            $.ajax({
                type: 'GET',
                url: '{{ url('/pascapelatihan/get') }}/' + pelatihanId,
        ...
        $(document).ready(function() {
            ...
            $('#nrp-dropdown').on('change', function() {
                ...
                $.ajax({
                    type: 'POST',
                    url: '/pascapelatihan/get_user_info',
                    data: {
                        nrp: selectedNrp,
                        _token: '{{ csrf_token() }}'
                    },
        ...
        $(document).ready(function() {
            $('#btn-yes-edit').click(function() {
                ...
                $.ajax({
                    ...
                    url: '{{ url('/pascapelatihan/myedit') }}/' + pelatihanId,
                    headers: {
        ...
        document.querySelectorAll('.delete').forEach(function(link) {
            link.addEventListener('click', function(event) {
                ...
                var pascapelatihanId = this.getAttribute('data-id');
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        axios.post('{{ route('delete.pascapelatihan') }}', {
                                pascapelatihan_id: pascapelatihanId
                            })
