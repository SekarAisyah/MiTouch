              ...
              <h3 style="text-align: center;">{{ auth()->user()->jabatan }}</h3>
               ...
               <div class="profile-card profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-7 col-md-8">{{ auth()->user()->departemen }}</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-4 col-md-4 label">Jabatan</div>
                    <div class="col-lg-8 col-md-8">{{ auth()->user()->jabatan }}</div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-8 col-md-8">{{ auth()->user()->phone_number }}</div>
                  </div>
                ...
                <div class="tab-pane fade show active profile-edit pt-3" id="profile-edit">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="departemen" type="text" class="form-control" id="departemen" value="{{ auth()->user()->departemen }}">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="jabatan" type="text" class="form-control" id="Jabatan" value="{{ auth()->user()->jabatan }}">
                      </div>
                    </div>
